  ...
  return (
    <section id="forms" className="py-16 sm:py-20 section-white scroll-mt-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        {/* Note */}
        <div
          className="mt-12 rounded-xl p-8 animate-fade-up"
          style={{
            animationDelay: "0.4s",
        ...
        >
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="text-center sm:text-left">
              <p className="font-semibold text-white">Need help with forms?</p>
              <p className="text-sm text-white/70 mt-1">
                Contact our EdTech team for assistance with forms or submission
                procedures.
              </p>
            </div>
            <button
              onClick={scrollToHotline}
              className="inline-flex items-center gap-2 btn-primary whitespace-nowrap text-white"
            >
              Contact Hotline
